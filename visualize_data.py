...
if __name__ == '__main__':
    vd = VisualizeData(deeplake_module = DeepLakeDataset, deeplake_dataset='hub://activeloop/imagenet-train', visualize_batch_size=2, visualize_shuffle=False, deeplake_token=cred.DEEPLAKE_TOKEN, num_images=10)
